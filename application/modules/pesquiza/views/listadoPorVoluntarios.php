...
<?php echo anchor('pesquiza/generarAuto', 'Gen. Pesquiza', 'id="botGeneraAuto"');?>
<?php echo anchor('pesquiza/listadoPorVoluntarios', 'List. Por Vol.', 'id="ListVoluntarios"');?>
<?php echo anchor('pesquiza/imprimirCartas', 'Imprimir Cartas Diag.', 'id="botCartas"');?>
<?php echo anchor('pesquiza/definirTurnos', 'Definir Turnos Diag.', 'id="botDefTurnos"');?>
...
<table cellpadding="3" width="100%">
  <tbody>
    ...
    <tr >
      <td colspan="6" >
        <div id="F<?php echo $pesq->escuela_id?>">
        </div>
      </td>
    </tr>
    <?php endforeach;?>
...
$("#ListVoluntarios").button({icons:{primary:'ui-icon-person'}});
